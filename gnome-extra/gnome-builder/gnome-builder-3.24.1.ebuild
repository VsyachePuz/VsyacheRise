...
SLOT="0"
KEYWORDS="amd64 x86"
IUSE="clang +git +cxx sysprof vala webkit"
REQUIRED_USE="${PYTHON_REQUIRED_USE}"

SRC_URI="https://download.gnome.org/sources/gnome-builder/3.24/gnome-builder-3.24.1.tar.xz"
...
RDEPEND="
	...
	cxx? (
		...
		>=sys-devel/autoconf-archive-2016.03.20 )
	git? (
